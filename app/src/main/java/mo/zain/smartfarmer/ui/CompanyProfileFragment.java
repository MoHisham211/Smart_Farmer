...
//                SignInFragmentDirections.actionSignInFragmentToUserNameFragment());
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_companyProfileFragment_to_companyHomeFragment);
            }
        });
    ...
    private void loadInfo()
    {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                userNameEt.setText(map.get("companyname"));
                emailEt.setText(map.get("email"));
                mobileEt.setText(map.get("phone"));
                try {
    ...
    private void updateProfile()
    {
        if (imageuri != null&& !userNameEt.getText().toString().isEmpty()&&
            ...
            }else if (emailEt.getText().toString().isEmpty())
            {
                ...
                map.put("companyname",userNameEt.getText().toString());
                map.put("email",emailEt.getText().toString());
                map.put("phone",mobileEt.getText().toString());
