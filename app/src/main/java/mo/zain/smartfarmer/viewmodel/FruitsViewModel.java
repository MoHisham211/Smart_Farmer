...
public class FruitsViewModel extends ViewModel {
    public MutableLiveData<List<Plant>> fruitsMutableLiveData = new MutableLiveData<>();
    MutableLiveData<String> fruits = new MutableLiveData<>();

    public void getFruits() {
        Observable<List<Plant>> observable = PlantsClient.getINSTANCE().getFruits()
        ...
        Observer<List<Plant>> observer = new Observer<List<Plant>>() {
            ...
            @Override
            public void onNext(@NonNull List<Plant> fruits) {
                Log.i("Hussein","next");
